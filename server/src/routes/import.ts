        ...
        if (existing) {
          ...
          if (duplicateAction === 'replace') {
            ...
            await prisma.resource.update({
              ...
              data: { title, category, collection, language, resourceType: resourceType as any, fileType: typeLabel, fileHash: fileHash || existing.fileHash, featured: defaultFeatured, teacherId: shaykhId, updatedAt: new Date() },
            });
