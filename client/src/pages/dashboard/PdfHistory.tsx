    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        >
          ...
          <Link to="/pdfs" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium transition-all mt-4">
