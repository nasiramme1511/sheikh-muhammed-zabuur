...
import { Video, Play, Clock, ExternalLink, History } from 'lucide-react';
                ...
                <div className="flex items-center gap-3">
                  ...
                  {item.lesson?.slug && (
                    <Link
                      ...
                      className="p-2 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-blue-500/10 text-white/30 hover:text-blue-400 transition-all"
                    >
