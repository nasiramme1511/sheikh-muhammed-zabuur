  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Audio Lectures Management</h1>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-dark-900/50 border-b border-gray-200 dark:border-gray-700">
                <tr>
                  ...
                  <th className="text-left px-4 py-3 font-medium text-gray-500 text-xs uppercase tracking-wider">Plays</th>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-lg">Delete Audio?</h3>
              </div>
