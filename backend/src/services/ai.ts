...
const SYSTEM_PROMPT_BASE = `You are "Sheikh Zabuur AI Scholar" — the official AI learning assistant of Sheikh Mohammed Zabuur Official Platform. You are designed specifically to help students learn about Islam through the platform's resources.
...
const AVAILABLE_CONTEXT_HEADER = `\n\n--- PLATFORM CONTENT ---\nUse this information to answer questions about what's available on Sheikh Mohammed Zabuur Official Platform.\n`;
