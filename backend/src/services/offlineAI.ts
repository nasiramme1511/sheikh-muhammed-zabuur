...
const FALLBACKS: Record<string, FallbackGroup> = {
  greetings: {
    ...
    responses: [
      () => "Wa alaykum assalam wa rahmatullahi wa barakatuh! 👋\n\nI'm the Sheikh Zabuur AI Scholar, currently in offline mode. I can still answer many questions about our platform and Islamic studies. What would you like help with?",
      () => "Hello! 🌙 Welcome to Sheikh Mohammed Zabuur Official Platform. The AI Scholar is operating in offline mode right now, but I'm still here to guide you. Feel free to ask about lessons, teachers, or where to begin your Islamic learning journey.",
    ],
  },
  beginner: {
