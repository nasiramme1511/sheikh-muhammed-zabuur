...
const DEFAULT_DESCRIPTION = 'Sheikh Mohammed Zabuur - Authentic Islamic education platform. Learn Aqeedah, Tafsir, Hadith, Fiqh and more from qualified Sunni teachers.';
const DEFAULT_IMAGE = '/og-image.png';
const SITE_NAME = 'Sheikh Mohammed Zabuur Official Platform';
