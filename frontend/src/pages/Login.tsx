...
export default function Login() {
  useSEO({
    title: 'Login',
    description: 'Sign in to your account on Sheikh Mohammed Zabuur to access bookmarks, downloads, and learning history.',
  });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-purple-500/5 rounded-full blur-[120px]" />
