...
export default function Terms() {
  ...
  useSEO({
    ...
    structuredData: {
      '@type': 'WebPage',
      name: 'Terms of Service - Sheikh Mohammed Zabuur',
      description: 'Terms of service for Sheikh Mohammed Zabuur outlining user responsibilities, intellectual property, and platform rules.',
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mt-8">
          <p className="text-white/40 text-sm">
            By using Sheikh Mohammed Zabuur, you agree to these terms. If you have questions, please <Link to="/contact" className="text-icc-400 hover:text-icc-300 transition-colors">contact us</Link>.
          </p>
        </div>
      </div>
    </div>
