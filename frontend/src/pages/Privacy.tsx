...
export default function Privacy() {
  ...
  useSEO({
    ...
    structuredData: {
      '@type': 'WebPage',
      name: 'Privacy Policy - Sheikh Mohammed Zabuur',
      description: 'Privacy policy for Sheikh Mohammed Zabuur detailing how user data is collected, used, and protected.',
